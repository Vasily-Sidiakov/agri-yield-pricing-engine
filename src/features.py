...
# ==============================================================================
#  AGRONOMIC CONSTANTS (Aligned with Biophysics Engine)
# ==============================================================================
CROP_PROFILES = {
    'corn_us':      {'t_base': 8,  't_opt': 30, 't_max': 45, 'frost_sensitive': False, 'heat_sensitive': True},
    'soybeans_us':  {'t_base': 10, 't_opt': 29, 't_max': 40, 'frost_sensitive': False, 'heat_sensitive': True},
    'wheat_us':     {'t_base': 0,  't_opt': 22, 't_max': 35, 'frost_sensitive': False, 'heat_sensitive': False}, 
...
def process_weather_features(commodity_key):
    ...
    for region in commodity['regions']:
        ...
        try:
            ...
            # 1. Non-Linear Growth (Beta Function)
